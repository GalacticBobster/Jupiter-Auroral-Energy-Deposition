...
#Electron impact vibrationally excited state
...
with open("../Hrates/Mono1000keV_Hrate.txt", "w") as f:
  for i in range(len(Hgrid)-1, -1, -1):
    f.write(str(Hgrid[i]) + "," + str(Heat_rate[i]) + "," + str(e_rate[i])  + "\n")
f.close()


with open("../Irates/Mono1000keV_Irate.txt", "w") as f:
