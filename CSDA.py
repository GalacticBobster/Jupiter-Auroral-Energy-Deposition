...
# print(str(Hgrid[i]) + "," + str(Heat_rate[i]) + "," + str(e_rate[i]) )
 ...
 d4 = Ev2[i]/array(H2)[i]
 d5 = Ev3[i]/array(H2)[i]
# if(H2p_rate[i]/array(H2)[i] < 1e-50):
#     d1 =  0
# if(Hp_rate[i]/array(H2)[i] < 1e-50):
#     d2 = 0
# if(Ev1[i]/array(H2)[i] < 1e-50):
#     d3 = 0
# if(Ev2[i]/array(H2)[i] < 1e-50):
#     d4 = 0
# if(Ev3[i]/array(H2)[i] < 1e-50):
 #    d5 = 0
